...
# 导入数据集
postings <- read_csv('职业评估数据集/postings.csv')
companies <- read_csv("职业评估数据集/companies/companies.csv")
employee_counts <- read_csv("职业评估数据集/companies/employee_counts.csv")
